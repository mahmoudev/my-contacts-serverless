...
import { CreateContactRequest as CreateContactRequest } from '../types/CreateContactRequest';
...
export async function getUploadUrl(
  ...
  const response = await Axios.post(`${apiEndpoint}/contacts/${contactId}/contactImage`, '', {
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${idToken}`
    }
